 ...
 (function()
{
    ...
    Tab = function(data, parentViewModel)
    {
        ...
        this.show = function()
        {
            $.each(parentViewModel.tabs(), function(index, element)
            {
    ...
    ko.bindingHandlers.tabs = 
    {
        ...
        {
            var value = valueAccessor(), tabsContainer = element.appendChild(document.createElement("DIV"));
            ko.renderTemplate("tabsContainerTemplate", value, 
            {
                templateEngine : templateEngine
            }, tabsContainer, "replaceNode");
            ...
            var active = value.tabs().filter(function(i)
            {
