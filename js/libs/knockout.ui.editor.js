 ...
 (function()
{
    ...
    ko.contenteditable = 
    {
        actions : 
        {
            viewHtmlModal : function(area)
            {
                ...
                ko.contenteditable.util.createModal(viewModel, 
                {
                    width : 760,
                    height : 500
                });
            ...
            createHyperlinkModal : function(area)
            {
                ...
                var sel = rangy.getSelection(), range = ko.contenteditable.util.getFirstRange(), $node = sel !== undefined ? $(sel.anchorNode) : undefined, href,
                title,
                target;
            ...
            createCodeModal : function(area)
            {
                ...
                ko.contenteditable.util.saveSelection();
                var sel = rangy.getSelection(), range = sel.rangeCount ? sel.getRangeAt(0) : null, $pre = sel !== undefined ? $(sel.anchorNode) : undefined, contents = range !== undefined ? range.cloneContents() : undefined, $containedNode = contents.childNodes.length == 1 ? $(contents.childNodes[0]) : undefined, initialValue,
                initialMode,
                existingCodeBlock;
                ...
                var CodePreview = function(value, element)
                {
                    ...
                    this.selectedLanguage = function()
                    {
                        ...
                        if(selectedLang)
                        {
                            return allLanguages.filter(function(x)
                            {
                                return x.name === selectedLang;
                            })[0];
                        }
                    }.bind(this);
                ...
                {
                    var langSelected = viewModel.languages().filter(function(x)
                    {
                        return x.name === initialMode;
                    });
            ...
            createImageModal : function(area)
            {
                ...
                var Thumb = function(data, image)
                {
                    ...
                    {
                        var widthRatio = this.frameWidth() / this.imageWidth, heightRatio = this.frameHeight() / this.imageHeight, ratio = widthRatio < heightRatio ? heightRatio : widthRatio;
                        return ratio;
                        // don't resize if it already fits in the frame							
                    }.bind(this);
        ...
        util : 
        {
            ...
            createModal : function(contents, settings)
            {
                ...
                var viewModel = 
                {
                    close : function()
                    {
                        $('.ui-modal, .ui-modal-shroud').fadeOut(function()
                        {
                            $(this).remove();
                        });
                    },
                ...
                ko.renderTemplate("modalTemplate", viewModel, 
                {
        ...
        command : 
        {
            ...
            ul : function()
            {
                ...
                this.focus();
                // needed as we loose focus when applied
                this.change();
            },
            ol : function()
            {
            ...
            code : function(lang, mode, mime, contents)
            {
                ...
                var codeSnippet = $('<pre></pre>').addClass('code').attr('contenteditable', 'false').attr('data-lang', lang).attr('data-mode', mode).attr('data-mime', mime).text(contents);
    ...
    var templateEngine = new ko.jqueryTmplTemplateEngine(), Button = function(settings, parent)
    {
            ...
            groups : [
            {
                ...
                }, 
                {
                    buttons : [
                    {
                        name : 'Bulletted List',
                        iconClass : 'list',
                        description : 'add a bulletted list',
                        execCmd : 'ul'
                    }, 
                    {
                        name : 'Numbered List',
                        iconClass : 'orderedlist',
            ...
            }, 
            {
                ...
                rows : [
                {
                    ...
                    }, 
                    {
                        ...
                        description : 'Align the text center',
                        execCmd : 'align',
                        args : ['center']
                    }, 
                    {
                        ...
                        description : 'Align the text right',
                        execCmd : 'align',
                        args : ['right']
                    }]
                }, 
                {
                    buttons : [
                    {
                        name : 'Heading',
                        iconClass : 'heading',
                        description : 'select a heading number from below',
                        buttons : [
                        {
                            name : 'H1',
                            text : '1',
                            execCmd : 'heading',
                            description : 'make the selected text a heading 1',
                            args : [1]
                        }, 
                        {
                            name : 'H2',
                            text : '2',
                            execCmd : 'heading',
                            description : 'make the selected text a heading 2',
                            args : [2]
                        }, 
                        {
                            name : 'H3',
                            text : '3',
                            execCmd : 'heading',
                            description : 'make the selected text a heading 3',
                            args : [3]
                        }, 
                        {
                            name : 'H4',
                            text : '4',
                            execCmd : 'heading',
                            description : 'make the selected text a heading 4',
                            args : [4]
                        }, 
                        {
                            name : 'H5',
                            text : '5',
                            execCmd : 'heading',
                            description : 'make the selected text a heading 5',
                            args : [5]
                        }]
                    }, 
                    {
                        ...
                        description : 'make the selected text superscript',
                        execCmd : 'superscript'
                    }, 
                    {
                        name : 'Subscript',
                        iconClass : 'subscript',
                        description : 'make the selected text subscript',
                        execCmd : 'subscript'
                    }]
                }]
            }, 
            {
                ...
                rows : [
                {
                    buttons : [
                    {
                        ...
                        execCmd : ko.contenteditable.actions.createHyperlinkModal
                    }, 
                    {
                        name : 'Code',
                        iconClass : 'code',
                        description : 'insert a code block',
                        execCmd : ko.contenteditable.actions.createCodeModal
                    }, 
                    {
                        name : 'Html',
                        iconClass : 'html',
                        description : 'view/edit the html',
                        execCmd : ko.contenteditable.actions.viewHtmlModal
                    }
                    ]
                }, 
                {
                    buttons : [
                    {
                        ...
                        description : 'add a blockquote (does not work in IE)',
                        execCmd : 'blockquote'
                    }, 
                    {
                        name : 'Image',
                        ...
                        execCmd : ko.contenteditable.actions.createImageModal
                    }, 
                    {
                        name : 'RemoveFormat',
                        iconClass : 'removeFormat',
                        description : 'remove formatting from the current selection',
    ...
    ko.bindingHandlers.editable = 
    {
        'init' : function(element, valueAccessor, allBindingsAccessor, viewModel)
        {
            ...
            var $element = $(element), settings = ko.utils.unwrapObservable(valueAccessor()), output = allBindingsAccessor()['output'], area,
            instance,
            container;
            ...
            if( ! settings.rendered)
            {
                ...
                ko.renderTemplate("editorTemplate", settings.editor, 
                {
                    templateEngine : templateEngine
                }, container, "replaceNode");
    ...
    ko.bindingHandlers.editorPosition = 
    {
        'init' : function(element, valueAccessor, allBindingsAccessor, viewModel)
        {
            var $element = $(element), dragOptions = 
            {
                addClasses : false,
                handle : '.move',
                scroll : false,
