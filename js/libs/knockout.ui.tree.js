 ...
 (function()
{
    ...
    templateEngine = new ko.jqueryTmplTemplateEngine(), typeValueOrDefault = function(param, type, viewModel)
    {
    ...
    Node = function(data, parent, viewModel)
    {
        ...
        this.level = ko.dependentObservable(function()
        {
            try
            {
                var pname = this.parent().name(), plevel = this.parent().level();
        ...
        {
            var name = this.name(), childRenaming = false, typeDefault = typeValueOrDefault('isDraggable', this.type(), this.viewModel);
        ...
        viewModel : function(configuration)
        {
            ...
            this.addNode = function(options)
            {
                ...
                else
                {
                    ...
                    {
                        // add to root
                        var type = options.type !== undefined ? options.type : typeValueOrDefault('childType', undefined, this), name = options.name !== undefined ? options.name : typeValueOrDefault('name', type, this), rename = options.rename !== undefined ? options.rename : typeValueOrDefault('renameAfterAdd', type, this);
    ...
    ko.bindingHandlers.tree = 
    {
        init : function(element, viewModelAccessor, allBindingsAccessor, viewModel)
        {
            ...
            ko.renderTemplate("containerTemplate", value, 
            {
                templateEngine : templateEngine
            }, treeContainer, "replaceNode");
